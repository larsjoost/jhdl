  ...
  namespace STD {
    ...
    /*
      ...
      */
       ...
       * The implementation must be defined in a .cpp file in this directory.
      */
      void TEXTIO::std_textio_writeline(TEXT<> F, LINE<> L){ assert(false); }
      /*
       * This is the definition of the foreign function set as an attribute.
       * The implementation must be defined in a .cpp file in this directory.
      */
      ...
      */
       ...
       * The implementation must be defined in a .cpp file in this directory.
      */
      void TEXTIO::std_textio_write5(LINE<> L, STD::STANDARD::INTEGER<> VALUE, SIDE<> JUSTIFIED, WIDTH<> FIELD){ assert(false); }
      /*
       * This is the definition of the foreign function set as an attribute.
       * The implementation must be defined in a .cpp file in this directory.
      */
